...
export type typeReduxConfig = () => Store<
  EmptyObject & { app: typeInitState },
  actionAppReducer
> & { dispatch: unknown };

export type typeAppReducer = (
  state: typeInitState | undefined,
  action: actionAppReducer
) => typeInitState;

export type typeRootReducer = Reducer<
  CombinedState<{ app: typeInitState }>,
  actionAppReducer
>;
